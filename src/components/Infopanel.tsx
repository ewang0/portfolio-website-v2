  ...
  return (
    <div className='hidden lg:flex flex-col relative col-span-2 overflow-y-auto text-pretty'>
        ...
        <div className='flex flex-col gap-4 px-5 py-5 border-neutral-700'>
            ...
            <p className='text-base text-pretty'>Formerly an engineer at Amazon and Lippincott. Currently doing freelance work  and building cool things with AI.</p>
        </div>
        <div className='py-5 mx-5 border-t border-neutral-700'>
          ...
          <div className='flex flex-col gap-4 w-full'>
              <div className='flex flex-col'>
                  ...
                  <div className='dark:text-neutral-400 text-balance text-base'>Front End Engineer, 2022 - 2023</div>
              </div>
              <div className='flex flex-col'>
                  <div className='font-medium'>Lippincott</div>
                  <div className='dark:text-neutral-400 text-balance text-base'>Design Technologist, 2023 - 2024</div>
              </div>
              <div className='flex flex-col'>
                  <div className='font-medium'>Freelance</div>
                  <div className='dark:text-neutral-400 text-balance text-base'>Full Stack Engineer, 2024 - Present</div>
              </div>
          </div>
        </div>
    </div>
